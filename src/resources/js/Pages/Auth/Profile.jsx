    ...
    return (
        <AuthCard title='Profile'>
            ...
            <div className='mt-6 flex gap-3 border-t pt-4'>
                <button
                    onClick={logout}
                    className='w-full rounded-lg bg-gray-700 py-2 text-white transition hover:bg-gray-800'
                >
                    Log out
                </button>
                ...
                <button
                    ...
                    className='w-full rounded-lg bg-red-600 py-2 text-white transition hover:bg-red-700'
                >
                    アカウント削除
                </button>
            </div>
